        ...
        <nav className={cx('wrapper')}>
            <div className={cx('container')}>
                ...
                <ul className={cx('navbar')}>
                    ...
                    <li>
                        <NavLink to="/explore" className={classes}>
                            <div className={cx('icon')}>
                                <FaRegCompass />
                            </div>
                    ...
                    <li>
                        <NavLink to="/reels" className={classes}>
                            <div className={cx('icon')}>
                                <BsPlayCircle />
                            </div>
                    ...
                    <li>
                        <NavLink to="/message" className={classes}>
                            <div className={cx('icon')}>
                                <RiMessengerLine />
                            </div>
                    ...
                    <li>
                        <NavLink to="" className={cx('item')}>
                            <div className={cx('icon', 'profile-img')}>
                    ...
                    <li>
                        <NavLink to="" className={cx('item', 'menu')}>
                            <div className={cx('icon', 'profile-img')}>
                                <AiOutlineMenu />
                            </div>
                            <div className={cx('title')}>More</div>
                        </NavLink>
                    </li>
                </ul>
            </div>
